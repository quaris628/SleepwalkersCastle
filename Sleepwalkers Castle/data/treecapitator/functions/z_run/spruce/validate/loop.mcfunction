...
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~ if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~-1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~-1 if block ~ ~ ~ minecraft:spruce_log run function treecapitator:z_run/spruce/validate/loop