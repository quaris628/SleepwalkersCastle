...
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~ if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~-1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~-1 if block ~ ~ ~ minecraft:acacia_log run function treecapitator:z_run/acacia/validate/loop