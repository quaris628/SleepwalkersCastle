...
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~ if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~-1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~-1 if block ~ ~ ~ minecraft:dark_oak_log run function treecapitator:z_run/dark_oak/validate/loop