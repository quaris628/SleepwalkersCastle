...
execute as @p[scores={tc.break_oak=1,tc.use_axe=1}] run function treecapitator:z_damage/setdurability
...
execute as @p[scores={tc.break_oak=1,tc.use_axe=1}] run function treecapitator:z_damage/calculate
...
#Cut tree
execute if score Durability tc.value >= Damage tc.value as @p[scores={tc.break_oak=1,tc.use_axe=1}] run function treecapitator:z_break/main