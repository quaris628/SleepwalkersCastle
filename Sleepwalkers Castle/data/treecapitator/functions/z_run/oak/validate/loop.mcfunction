...
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~ if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~-1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~-1 if block ~ ~ ~ minecraft:oak_log run function treecapitator:z_run/oak/validate/loop